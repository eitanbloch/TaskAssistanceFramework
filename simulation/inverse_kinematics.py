...
if __name__ == '__main__':
    ...
    bb = Building_Blocks(transform=transform, transform_camera=transform, ur_params=ur_params, env=env, resolution=0.1,
                         p_bias=0.05)
    visualizer = Visualize_UR(ur_params, env=env, transform=transform, transform_camera=transform, bb=bb)
    candidate_sols = []
